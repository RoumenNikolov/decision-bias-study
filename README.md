...
The datasets can be downloaded in two ways:
...
curl -o data\input\L2M_stats_nba.zip "$BASE_URL/L2M_stats_nba.zip"
curl -o data\input\nba_2008-2025.zip "$BASE_URL/nba_2008-2025.zip"
```
...
```python
# Uncomment the URL line in the notebook instead of the local path
...
3. Download both datasets and place them in `data/input/`
